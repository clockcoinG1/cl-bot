...
class CraigslistEvents(CraigslistBase):
    ...
    extra_filters = {
        ...
        # fitness/health
        "fitness": {
            "url_key": "event_fitness_wellness",
            "value": 1,
            "attr": "fitness/health",
        },
        "health": {
...
class CraigslistForSale(CraigslistBase):
    ...
    extra_filters = {
        ...
        "min_engine_displacement": {
            "url_key": "min_engine_displacement_cc",
            "value": None,
        },
        "max_engine_displacement": {
            "url_key": "max_engine_displacement_cc",
            "value": None,
        },
    }
